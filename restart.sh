...
docker-compose --env-file .env -f docker-compose.server.yml up --force-recreate --detach --remove-orphans

docker-compose --env-file .env -f docker-compose.server.yml exec --user deploy api bin/console doctrine:migrations:migrate --no-interaction
